...
nohup java -jar jenkins.war & ( to run jenkins process in background )
...
//Link --https://github.com/DeekshithSN/cheatsheet/blob/master/installtion_guide_ubuntu.md

// fixed the internet getaway and it worked like a gem